/**
 * @file Thesis Analysis Tab Component
 ...
 * Redesigned to work within the new tabbed sidebar structure.
 */
'use client';
...
export interface ThesisAnalysisData {
  analysis: ThesisAnalysis;
  alternatives: ThesisAlternative[];
}

interface ThesisAnalysisTabProps {
...
/**
 * Main thesis analysis tab component
 */
export function ThesisAnalysisTab({
  data,
  isLoading,
  onApplyAlternative,
}: ThesisAnalysisTabProps) {
  return (
    <div className="h-full">
      ...
      {data && !isLoading && (
        <div className="space-y-6">
          {/* Overall Score */}
          <Card className="p-4 bg-white/60 backdrop-blur-sm border-white/70">
          ...
          {data.alternatives.length > 0 && (
            <div className="space-y-4">
              ...
              {data.alternatives.map((alternative, index) => (
                <Card key={index} className="p-4 bg-white/60 backdrop-blur-sm border-white/70">
